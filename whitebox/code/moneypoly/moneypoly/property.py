"""Property and color-group models used by the MoneyPoly board."""
...
class PropertyGroup:
    """Represent a monopoly color group and the properties inside it."""
    ...
    def all_owned_by(self, player):
        ...
        return bool(self.properties) and all(
            prop.owner == player for prop in self.properties
        )
